...
(cl:defmethod cl:initialize-instance :after ((m <ImageRect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageRect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<ImageRect> is deprecated: use smartcar_msgs-msg:ImageRect instead.")))
