...
(cl:defclass <ImageRectRanged> (roslisp-msg-protocol:ros-message)
  ((rect
    :reader rect
    :initarg :rect
    :type smartcar_msgs-msg:ImageRect
    :initform (cl:make-instance 'smartcar_msgs-msg:ImageRect))
   (range
    :reader range
    :initarg :range
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <ImageRectRanged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageRectRanged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<ImageRectRanged> is deprecated: use smartcar_msgs-msg:ImageRectRanged instead.")))

(cl:ensure-generic-function 'rect-val :lambda-list '(m))
(cl:defmethod rect-val ((m <ImageRectRanged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:rect-val is deprecated.  Use smartcar_msgs-msg:rect instead.")
  (rect m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ImageRectRanged>)))
  ...
  (cl:format cl:nil "ImageRect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: smartcar_msgs/ImageRect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ImageRectRanged)))
  "Returns full string definition for message of type 'ImageRectRanged"
  (cl:format cl:nil "ImageRect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: smartcar_msgs/ImageRect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
